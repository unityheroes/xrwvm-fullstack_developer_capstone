...
def initiate():
    ...
    car_model_data = [
        {"name":"A1", "type":"SUV", "year": 2023, "car_make":car_make_instances[0]},
        ...
        {"name":"Hilux", "type":"Pickup", "year": 2024, "car_make":car_make_instances[0]},
        {"name":"GLE", "type":"SUV", "year": 2024, "car_make":car_make_instances[1]},
        {"name":"Q7", "type":"SUV", "year": 2024, "car_make":car_make_instances[2]},
        {"name":"Sportage", "type":"SUV", "year": 2024, "car_make":car_make_instances[3]},
        {"name":"Supra", "type":"Sports", "year": 2024, "car_make":car_make_instances[4]},
    ]
